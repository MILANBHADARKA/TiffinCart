          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <input
                ...
                type="password"
                {...register('password')}
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors ${errors.password ? 'border-red-500' : 'border-gray-300'
                  }`}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <label className={`relative flex items-center p-4 border rounded-lg cursor-pointer transition-all ${watchRole === 'customer'
                ...
                <label className={`relative flex items-center p-4 border rounded-lg cursor-pointer transition-all ${watchRole === 'seller'
                    ? 'border-orange-500 bg-orange-50 ring-2 ring-orange-500'
                    : 'border-gray-300 hover:border-gray-400'
                  }`}>
                  <input
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs text-gray-500">Sell food</span>
                  </div>
                </label>
              </div>
              {errors.role && (
